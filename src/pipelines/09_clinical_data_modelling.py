"""Train and evaluate the clinical-data models."""
...
logger.info("Loading libraries and setting configurations...")
...
def main() -> None:
    ...
    logger.info("Features' coefficients forced out: %s", irrelevant_cols)
