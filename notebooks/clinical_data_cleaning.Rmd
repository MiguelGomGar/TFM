...
new_names <- c(
    ...
    "renal_insuf", "hypertension", "COPD", "stroke", "heart_failure", "cardiomyopathy", 
...
# Save data
This is the entire data set. Lets save it:
...
Save specific subset for scores:

```{r}
# Save specific subset for scores
clinical_data_processed |> 
    select(AF_recurrence, age, heart_failure, hypertension, COPD, stroke, OSA) |> 
    write_parquet("data/clean/HATCH_clinical_data.parquet")
```
