...
```{r}
new_names <- c(
    "gender", "age", "smoking_status", "code", "center", "intervention", "BMI", 
    "waist_circumference", "height", "Met", "glucose", "type1_diabetes", "HDL", 
    "triglicerides", "hypercholesterolemia", "hypolipidemic_meds", "OSA", 
    "renal_insuf", "hypertension", "stroke", "heart_failure", "cardiomyopathy", 
    "antirrythmic_meds", "LA_enlargment", "LAD", "LAA", "LAV", "LVEF", "AF_type", 
    "AF_ablation_time", "previous_ablation", "ERAF", "p14_score", 
    "alcohol_intake", "AF_recurrence"
    )
...
clinical_data_processed <- clinical_data_processed |> 
    mutate(
        waist_to_height = waist_circumference / height,
        .after = BMI
    ) |> 
